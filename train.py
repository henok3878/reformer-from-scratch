...
class Trainer:
    ...
    def _save_checkpoint(self, value: int, is_epoch: bool):
        ...
        model_state_dict  = self.model.module.state_dict() if IS_DDP else self.model.state_dict() 
    ...
    def _compute_bleu(self, loader: DataLoader) -> float:
        ...
        if not IS_DDP:
            bleu = sacrebleu.corpus_bleu(local_hyps, [local_refs], tokenize="13a", lowercase=False)
            self.model.train()
            return bleu.score
